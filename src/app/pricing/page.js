...
const addons = [
  ...
  },
  {
    ...
    nameRu: 'Логистика', nameKg: 'Логистика',
    descRu: 'Отслеживание экспедиторов, статусы доставок, причины отказов',
    descKg: 'Экспедиторлорду козомолдоо, жеткируу статустары, баш тартуу себептери',
    priceRu: '3 000 сом/мес', priceKg: '3 000 сом/ай',
  },
  {
    icon: BarChart3,
    iconBg: 'bg-purple-100', iconColor: 'text-purple-600',
    nameRu: 'Агентская аналитика', nameKg: 'Агенттик аналитика',
    descRu: 'Аналитика по агентам: заказы, активность магазинов, рейтинг',
    descKg: 'Агенттер боюнча аналитика: заказдар, дукондордун активдуулугу',
    priceRu: '2 000 сом/мес', priceKg: '2 000 сом/ай',
  },
];
