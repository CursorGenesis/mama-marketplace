...
const featuresData = [
  ...
  },
  {
    ...
    descRu: 'Ваш профиль на MarketKG с названием компании, описанием, контактами и адресом. Клиенты видят все ваши товары в одном месте и могут связаться по телефону или WhatsApp.',
    descKg: 'MarketKG деги профилиңиз — компаниянын аты, сүрөттөмө, байланыш жана дарек. Кардарлар бардык товарларыңызды бир жерден көрүп, телефон же WhatsApp аркылуу байланыша алышат.',
  },
  {
    icon: '📋',
