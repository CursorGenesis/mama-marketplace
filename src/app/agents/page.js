...
export default function AgentsPage() {
  ...
  const faq = [
    ...
    },
    {
      ...
      aRu: 'Вы можете пригласить поставщика — он получит бесплатный месяц. А вы будете получать 2% от всех заказов через платформу.',
      qKg: 'Жеткирүүчү платформада болбосочу?',
      aKg: 'Жеткирүүчүнү чакырсаңыз болот — ал акысыз ай алат. Ал эми сиз платформа аркылуу бардык заказдардан 2% аласыз.',
    },
    {
      ...
      <div className="bg-gradient-to-br from-slate-800 via-slate-900 to-green-900 py-14 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-300 text-lg max-w-2xl mx-auto mb-8">
            {isRu
              ? 'Подключай магазины, оформляй заказы через приложение вместо бумажки — и получай 2% от каждого заказа.'
              : 'Дүкөндөрдү туташтырыңыз, заказдарды кагаздын ордуна тиркеме аркылуу тариздеңиз — жана ар бир заказдан 2% алыңыз.'}
          </p>
          <Link
          ...
          {[
            {
              ...
              titleRu: '2% от каждого заказа', titleKg: 'Ар бир заказдан 2%',
              descRu: 'Магазин заказывает через платформу — вы получаете 2% с каждого заказа. Каждый месяц пока вы агент.',
              descKg: 'Дүкөн платформа аркылуу заказ кылат — ар бир заказдан 2% аласыз. Агент болуп жатканда ар бир ай.',
            },
            {
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 mb-12">
          ...
          <div className="mb-4">
            <div className="py-2 px-4 bg-green-500 text-white rounded-lg text-sm font-semibold text-center">
              {isRu ? 'Комиссия агента — 2% с каждого заказа' : 'Агент комиссиясы — ар бир заказдан 2%'}
            </div>
          </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            {[
              ...
              { step: 4, emoji: '💰', titleRu: 'Получайте 2%', titleKg: '2% алыңыз', descRu: 'С каждого заказа ваших магазинов пока вы работаете агентом', descKg: 'Агент болуп иштеп жатканда дүкөндөрүңүздүн ар бир заказынан' },
            ].map(s => (
