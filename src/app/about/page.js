...
export default function AboutPage() {
  ...
  const clientBenefits = [
    ...
    { icon: <Gift size={24} />, title: isRu ? 'Розыгрыш призов' : 'Сыйлык розыгрышы', desc: isRu ? 'Собирайте монетки за каждый заказ и участвуйте в розыгрыше iPhone и других призов' : 'Ар бир заказ үчүн монета чогултуп, iPhone жана башка сыйлыктардын розыгрышына катышыңыз', color: 'bg-pink-50 text-pink-600' },
  ...
  const pricing = [
    ...
    { name: isRu ? 'Для агентов' : 'Агенттер үчүн', price: isRu ? '2% с заказа клиента' : 'Кардар заказынан 2%', features: [isRu ? 'Реферальная ссылка' : 'Реферал шилтемеси', isRu ? 'Привлечение клиентов' : 'Кардарларды тартуу', isRu ? 'Автоматическое начисление' : 'Автоматтык чегерүү', isRu ? 'Кабинет агента' : 'Агент кабинети', isRu ? 'Свободный график' : 'Эркин график'], color: 'border-amber-200 bg-amber-50', btn: 'bg-amber-600 hover:bg-amber-700' },
  ];
