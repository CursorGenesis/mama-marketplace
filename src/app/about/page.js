...
export default function AboutPage() {
  ...
  const faq = [
    ...
    { q: isRu ? 'Какие тарифы для поставщиков?' : 'Жеткирүүчүлөр үчүн тарифтер кандай?', a: isRu ? 'Первый месяц бесплатно на любом тарифе. Далее от 1 000 сом/мес. Комиссия 3–5% — в разы ниже чем на других маркетплейсах. Подробности на странице тарифов.' : 'Каалаган тарифте биринчи ай акысыз. Андан кийин 1 000 сом/айдан. Комиссия 3–5% — башка маркетплейстерге караганда алда канча аз. Толугураак тарифтер барагында.' },
