...
export default function AboutPage() {
  ...
  const clientBenefits = [
    ...
    { icon: <Gift size={24} />, title: isRu ? 'Бонусная программа' : 'Бонустук программа', desc: isRu ? 'Пригласите друга — получите бонусные баллы. Баллы можно потратить на продвижение в каталоге' : 'Досуңузду чакырыңыз — бонус баллдар алыңыз. Баллдарды каталогдо жылдыруу үчүн колдонуңуз', color: 'bg-pink-50 text-pink-600' },
  ...
  const supplierBenefits = [
    ...
    { icon: <Shield size={24} />, title: isRu ? 'Минимальная комиссия' : 'Минималдуу комиссия', desc: isRu ? 'Платите только за реальные заказы. Никаких абонентских плат и скрытых комиссий. Подробности — при регистрации' : 'Чыныгы заказдар үчүн гана төлөңүз. Жашыруун комиссиялар жок. Толугураак — катталууда', color: 'bg-red-50 text-red-600' },
  ...
  const faq = [
    ...
    { q: isRu ? 'Какая комиссия для поставщиков?' : 'Жеткирүүчүлөр үчүн комиссия кандай?', a: isRu ? 'Минимальная комиссия только с реальных заказов. Никаких абонентских плат и скрытых платежей. Подробности обсуждаем индивидуально — напишите нам в WhatsApp.' : 'Чыныгы заказдардан гана минималдуу комиссия. Абоненттик төлөмдөр жана жашыруун төлөмдөр жок. Толугураак — WhatsApp га жазыңыз.' },
